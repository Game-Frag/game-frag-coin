Contributing to GameFrag Core
============================

The GameFrag Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/pandagrows/gamefrag-frag-coin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the GameFrag Core project, and is not to be
confused with overall GameFrag Network Protocol consensus changes.

Whether a pull request is merged into GameFrag Core rests with the project merge
...
Patches that change GameFrag consensus rules are considerably more involved than
...
Where a patchset proposes to change the GameFrag consensus, it must have been
...
The project leader is the release manager for each GameFrag Core release.
