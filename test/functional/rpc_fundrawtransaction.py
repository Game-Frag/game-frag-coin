...
class RawTransactionsTest(GamefragTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid gamefrag address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid gamefrag address" in e.error['message'])
