...
from fake_stake.base_test import GameFrag_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(GameFrag_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zfragstake']] * self.num_nodes
