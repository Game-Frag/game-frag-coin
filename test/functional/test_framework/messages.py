...
COIN = 100000000  # 1 FRAG in satoshis
...
# Objects that map to gamefragd objects, which can be serialized/deserialized
class CAddress:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in gamefragd indicates these should be deserialized as blocks
