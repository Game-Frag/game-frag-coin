...
class GamefragTestFramework():
    ...
    """
    Create a ProReg tx, which references an 100 FRAG UTXO as collateral.
...
class GamefragDMNTestFramework(GamefragTestFramework):
...
class GamefragTier2TestFramework(GamefragTestFramework):
    ...
    def set_test_params(self):
        ...
        self.extra_args = [["-nuparams=v5_shield:249", "-nuparams=GAMEFRAG_v5.5:250", "-nuparams=v6_evo:250", "-whitelist=127.0.0.1"]] * self.num_nodes
