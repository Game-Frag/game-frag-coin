...
from test_framework.test_framework import GamefragTier2TestFramework
...
class MasternodeGovernanceBasicTest(GamefragTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.gamefrag.org/t/test-proposal"
