...
class FullBlockTest(GamefragTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure gamefragd isn't accepting b26
        ...
        # Extend the b28 chain to make sure gamefragd isn't accepting b28
        ...
        # GAMEFRAG: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the gamefrag code has custom code which does so);
