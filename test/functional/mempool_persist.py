...
By default, gamefragd will dump mempool on shutdown and
...
class MempoolPersistTest(GamefragTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent gamefragd from writing mempool.dat to disk. Verify that `savemempool` fails")
