...
Does not use functions of GamefragTier2TestFramework as we don't want to send
...
class MasternodePingTest(GamefragTestFramework):
    ...
    def run_test(self):
        ...
        collateralTxId = miner.sendtoaddress(mnAddress, Decimal('250000'))
        miner.generate(2)
        self.sync_blocks()
        time.sleep(1)
        collateral_rawTx = owner.getrawtransaction(collateralTxId, 1)
        assert_equal(owner.getbalance(), Decimal('250000'))
