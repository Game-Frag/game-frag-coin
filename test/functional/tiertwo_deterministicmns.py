...
class DIP3Test(GamefragTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 FRAG) to the operator, and (2 * 2.7 FRAG) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid GAMEFRAG address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid GAMEFRAG address InvalidPayee", controller.protx_update_registrar,
