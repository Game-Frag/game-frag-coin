...
class ListReceivedTest (GamefragTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 FRAG.
        ...
        # Send 1 FRAG to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 FRAG sending them all (fee is 0.1 FRAG)
        ...
        # Confirm transaction (2 FRAG from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 FRAG, send 0.6 FRAG + 0.05 FRAG fee
