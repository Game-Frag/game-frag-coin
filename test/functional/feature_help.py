...
"""Verify that starting gamefrag with -h works as expected."""
import subprocess

from test_framework.test_framework import GamefragTestFramework
from test_framework.util import assert_equal

class HelpTest(GamefragTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gamefrag with -h for help text")
        ...
        self.log.info("Start gamefrag with -version for version information")
