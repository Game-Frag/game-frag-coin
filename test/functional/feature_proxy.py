...
"""Test gamefragd with different proxy configuration.

Test plan:
- Start gamefragd's with different proxy configurations
...
- Create gamefragds that connect to them
- Manipulate the gamefragds using addnode (onetry) an observe effects
...
class ProxyTest(GamefragTestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        # Note: gamefragd's SOCKS5 implementation only sends atyp DOMAINNAME, even if connecting directly to IPv4/IPv6
