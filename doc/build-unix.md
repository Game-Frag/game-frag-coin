...
This will build gamefrag-qt as well, if the dependencies are met.
...
If you want to build gamefrag-qt, make sure that the required packages for Qt development
...
Notes
-----
The release is built with GCC and then "strip gamefragd" to strip the debug
