GAMEFRAG Core version v5.1.0 is now available from:  <https://github.com/gamefrag-project/gamefrag/releases>
...
- #2170 Better gamefrag.conf Masternode data error notification (furszy)
