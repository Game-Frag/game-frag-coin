...
To build GAMEFRAG Core using AFL instrumentation (this assumes that the
...
with certain assembly code from GAMEFRAG Core's code. See [developer notes on sanitizers](https://github.com/Game-Frag/game-frag-coin/blob/master/doc/developer-notes.md#sanitizers)
