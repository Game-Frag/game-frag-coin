...
The script [extract-osx-sdk.sh](https://github.com/gamefrag-project/gamefrag/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
gamefrag/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/gamefrag-project/gamefrag/blob/master/doc/README_osx.md) for troubleshooting tips.