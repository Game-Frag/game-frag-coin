 ...
 * GameFrag system. There are three: the main network on which people trade goods
...
public:
    ...
    int GamefragBadBlockTime() const { return nGamefragBadBlockTime; }
    int GamefragBadBlocknBits() const { return nGamefragBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nGamefragBadBlockTime;
    unsigned int nGamefragBadBlocknBits;
