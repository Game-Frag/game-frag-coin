...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop GameFrag server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "GameFrag server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GameFrag features */
        {"gamefrag", "listmasternodes", &listmasternodes, true, true, false},
        {"gamefrag", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gamefrag", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gamefrag", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"gamefrag", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"gamefrag", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"gamefrag", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gamefrag", "masternodedebug", &masternodedebug, true, true, false},
        {"gamefrag", "startmasternode", &startmasternode, true, true, false},
        {"gamefrag", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gamefrag", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gamefrag", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gamefrag", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gamefrag", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gamefrag", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gamefrag", "preparebudget", &preparebudget, true, true, false},
        {"gamefrag", "submitbudget", &submitbudget, true, true, false},
        {"gamefrag", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gamefrag", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gamefrag", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gamefrag", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gamefrag", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gamefrag", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gamefrag", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gamefrag", "checkbudgets", &checkbudgets, true, true, false},
        {"gamefrag", "mnsync", &mnsync, true, true, false},
        {"gamefrag", "spork", &spork, true, true, false},
        {"gamefrag", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzfragseed", &getzfragseed, false, false, true},
        {"zerocoin", "setzfragseed", &setzfragseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzfrag", &searchdzfrag, false, false, true},
        {"zerocoin", "dzfragstate", &dzfragstate, false, false, true},
...
{
    return "> gamefrag-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42021/\n";
}
