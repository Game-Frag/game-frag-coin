...
public:
    CLegacyZFragStake(const CBlockIndex* _pindexFrom, uint32_t _nChecksum, libzerocoin::CoinDenomination _denom, const uint256& _hashSerial) :
    ...
    static CLegacyZFragStake* NewZFragStake(const CTxIn& txin, int nHeight);
