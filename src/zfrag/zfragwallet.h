...
#ifndef GameFrag_ZFRAGWALLET_H
#define GameFrag_ZFRAGWALLET_H
...
public:
    CzFRAGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZFRAG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFRAG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
