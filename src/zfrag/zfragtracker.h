...
#ifndef GameFrag_ZFRAGTRACKER_H
#define GameFrag_ZFRAGTRACKER_H
...
public:
    CzFRAGTracker(std::string strWalletFile);
    ~CzFRAGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzFRAGWallet* zFRAGWallet = NULL);
