...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "gamefrag" is a composite category enabling all GameFrag-related debug output
            if (ptrCategory->count(std::string("gamefrag"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "gamefrag.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "gamefragd.pid"));
