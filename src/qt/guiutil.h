...
/** Utility functions used by the GAMEFRAG Qt UI.
 */
namespace GUIUtil
{
...
// Render GAMEFRAG addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZfrag = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZfrag = false);
...
// Parse "gamefrag:" URI into recipient object, return true on successful parsing
