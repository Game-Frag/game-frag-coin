                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFRAGPathCustom = GetArg("-zfragbackuppath", "");
    ...
    if(!strzFRAGPathCustom.empty()) {
        ui->wallet_customzfragbackuppath->setText(QString::fromStdString(strzFRAGPathCustom));
        ui->wallet_customzfragbackuppath_label->setVisible(true);
        ui->wallet_customzfragbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFRAGPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the GameFrag RPC console.") + "<br>" +
