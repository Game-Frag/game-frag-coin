...
// Copyright (c) 2015-2019 The GAMEFRAG Core developers
...
/** GAMEFRAG unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    //! Short name
    static QString name(int unit, bool isZfrag = false);
    //! Longer description
    ...
    static QString floorWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZFRAG = false);
    static QString floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZFRAG = false);
