...
#ifndef GameFrag_QT_WALLETMODEL_H
#define GameFrag_QT_WALLETMODEL_H
...
/** Interface to GameFrag wallet from Qt view code. */
...
#endif // GameFrag_QT_WALLETMODEL_H
