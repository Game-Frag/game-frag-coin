...
#include "qt/gamefrag/topbar.h"
#include "qt/gamefrag/forms/ui_topbar.h"
#include "qt/gamefrag/lockunlock.h"
#include "qt/gamefrag/qtutils.h"
#include "qt/gamefrag/receivedialog.h"
#include "qt/gamefrag/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/gamefrag/balancebubble.h"
...
TopBar::TopBar(GAMEFRAGGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopFrag, ui->labelAmountTopShieldedFrag}, "amount-small-topbar");
    setCssProperty({ui->labelAmountFrag}, "amount-topbar");
    setCssProperty({ui->labelPendingFrag, ui->labelImmatureFrag}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("GAMEFRAG")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // FRAG Total
    QString totalFrag = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // FRAG
    // Top
    ui->labelAmountTopFrag->setText(totalTransparent);
    ui->labelAmountTopShieldedFrag->setText(totalShielded);
    // Expanded
    ui->labelAmountFrag->setText(totalFrag);
    ui->labelPendingFrag->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureFrag->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
