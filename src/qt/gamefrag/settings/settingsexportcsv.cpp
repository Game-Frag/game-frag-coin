...
#include "qt/gamefrag/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(GAMEFRAGGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("GAMEFRAG_tx_csv_export(*.csv)") : tr("GAMEFRAG_addresses_csv_export(*.csv)"),
                                        nullptr);
