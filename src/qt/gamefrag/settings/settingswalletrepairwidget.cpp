// Copyright (c) 2019-2020 The GAMEFRAG Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "qt/gamefrag/settings/settingswalletrepairwidget.h"
#include "qt/gamefrag/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/gamefrag/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(GAMEFRAGGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to GAMEFRAGGUI::handleRestart()
