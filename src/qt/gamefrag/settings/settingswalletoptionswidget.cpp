...
#include "qt/gamefrag/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/gamefrag/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(GAMEFRAGGUI* _window, QWidget *parent) :
