...
QT_MOC_LITERAL(4, 51, 18), // "setMasternodeCount"
QT_MOC_LITERAL(5, 70, 14), // "strMasternodes"
QT_MOC_LITERAL(6, 85, 12), // "setNumBlocks"
QT_MOC_LITERAL(7, 98, 18) // "openNetworkMonitor"

    },
    "SettingsInformationWidget\0setNumConnections\0"
    "\0count\0setMasternodeCount\0strMasternodes\0"
    "setNumBlocks\0openNetworkMonitor"
};
...
void SettingsInformationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setMasternodeCount((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->setNumBlocks((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->openNetworkMonitor(); break;
        default: ;
        }
    }
}
