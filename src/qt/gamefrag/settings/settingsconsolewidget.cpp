...
#include "qt/gamefrag/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/gamefrag/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(GAMEFRAGGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the GAMEFRAG RPC console.") + "<br>" +
...
static bool PotentiallyDangerousCommand(const QString& cmd)
{
    ...
    if (cmd.size() >= 13 && cmd.leftRef(11) == "dumpprivkey") {
        // valid GAMEFRAG Transparent Address
        std::vector<std::string> args;
