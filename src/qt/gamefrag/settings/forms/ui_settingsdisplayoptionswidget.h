...
public:
    ...
    QHBoxLayout *horizontalPercentagezCrct;
    QLabel *labelTitleUnit;
    QSpacerItem *horizontalSpacerPercentagezCrct;
    QValueComboBox *comboBoxUnit;
    QSpacerItem *verticalDenomzCrct;
    QHBoxLayout *horizontalDenomzCrct;
    QLabel *labelTitleDigits;
    QSpacerItem *horizontalDenomzCrct_1;
    ...
    void setupUi(QWidget *SettingsDisplayOptionsWidget)
    {
        ...
        horizontalPercentagezCrct = new QHBoxLayout();
        horizontalPercentagezCrct->setObjectName(QStringLiteral("horizontalPercentagezCrct"));
        labelTitleUnit = new QLabel(left);
        labelTitleUnit->setObjectName(QStringLiteral("labelTitleUnit"));

        horizontalPercentagezCrct->addWidget(labelTitleUnit);

        horizontalSpacerPercentagezCrct = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalPercentagezCrct->addItem(horizontalSpacerPercentagezCrct);
        ...
        horizontalPercentagezCrct->addWidget(comboBoxUnit);


        verticalLayout_2->addLayout(horizontalPercentagezCrct);

        verticalDenomzCrct = new QSpacerItem(20, 10, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_2->addItem(verticalDenomzCrct);

        horizontalDenomzCrct = new QHBoxLayout();
        horizontalDenomzCrct->setObjectName(QStringLiteral("horizontalDenomzCrct"));
        labelTitleDigits = new QLabel(left);
        labelTitleDigits->setObjectName(QStringLiteral("labelTitleDigits"));

        horizontalDenomzCrct->addWidget(labelTitleDigits);

        horizontalDenomzCrct_1 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalDenomzCrct->addItem(horizontalDenomzCrct_1);
        ...
        horizontalDenomzCrct->addWidget(comboBoxDigits);


        verticalLayout_2->addLayout(horizontalDenomzCrct);
