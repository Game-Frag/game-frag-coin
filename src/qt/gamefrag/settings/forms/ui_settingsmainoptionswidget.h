...
public:
    ...
    QSpacerItem *verticalPercentagezCrct;
    QLabel *labelDivider;
    ...
    void setupUi(QWidget *SettingsMainOptionsWidget)
    {
        ...
        verticalPercentagezCrct = new QSpacerItem(20, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_2->addItem(verticalPercentagezCrct);
