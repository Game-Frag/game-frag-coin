...
public:
    ...
    void retranslateUi(QWidget *SettingsInformationWidget)
    {
        ...
        labelTitleMasternodes->setText(QApplication::translate("SettingsInformationWidget", "TextLabel", Q_NULLPTR));
        labelInfoMasternodes->setText(QApplication::translate("SettingsInformationWidget", "TextLabel", Q_NULLPTR));
        ...
        labelTitleBlockHash->setText(QApplication::translate("SettingsInformationWidget", "TextLabel", Q_NULLPTR));
        labelInfoBlockHash->setText(QApplication::translate("SettingsInformationWidget", "TextLabel", Q_NULLPTR));
