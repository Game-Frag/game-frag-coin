...
#include "qt/gamefrag/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(GAMEFRAGGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &GAMEFRAGGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
