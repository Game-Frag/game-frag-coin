...
public:
    ...
    void setupUi(QWidget *PrivacyWidget)
    {
        ...
        btnTotalzFRAG = new OptionButton(right);
        btnTotalzFRAG->setObjectName(QStringLiteral("btnTotalzFRAG"));
        btnTotalzFRAG->setMinimumSize(QSize(0, 50));

        verticalLayout_5->addWidget(btnTotalzFRAG);
