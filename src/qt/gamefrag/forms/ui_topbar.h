...
#include "qt/gamefrag/expandablebutton.h"
...
public:
    ...
    QLabel *labelAmountTopCrct;
    QSpacerItem *horizontalSpacer_11;
    QLabel *label_16;
    QSpacerItem *horizontalSpacer_12;
    QLabel *labelAmountTopzCrct;
    ...
    QLabel *labelTitle1;
    QLabel *labelAmountCrct;
    QHBoxLayout *horizontalLayout_2;
    QVBoxLayout *verticalLayout_3;
    QLabel *labelTitle3;
    QLabel *labelPendingCrct;
    QSpacerItem *horizontalSpacer_3;
    QVBoxLayout *verticalLayout_4;
    QLabel *labelTitle4;
    QLabel *labelImmatureCrct;
    QLabel *label_9;
    QVBoxLayout *verticalLayout_8;
    QVBoxLayout *verticalLayout;
    QLabel *labelTitle2;
    QLabel *labelAmountzCrct;
    QHBoxLayout *horizontalLayout;
    QVBoxLayout *verticalLayout_5;
    QLabel *labelTitle5;
    QLabel *labelPendingzCrct;
    QSpacerItem *horizontalSpacer_4;
    QVBoxLayout *verticalLayout_6;
    QLabel *labelTitle6;
    QLabel *labelImmaturezCrct;
    ...
    void setupUi(QWidget *TopBar)
    {
        ...
        labelAmountTopCrct = new QLabel(widgetTopAmount);
        labelAmountTopCrct->setObjectName(QStringLiteral("labelAmountTopCrct"));
        labelAmountTopCrct->setMinimumSize(QSize(0, 36));
        labelAmountTopCrct->setStyleSheet(QStringLiteral("padding:0px;margin:0px;"));

        horizontalLayout_5->addWidget(labelAmountTopCrct, 0, Qt::AlignTop);
...
"border:none;"));
        ...
        labelAmountTopzCrct = new QLabel(widgetTopAmount);
        labelAmountTopzCrct->setObjectName(QStringLiteral("labelAmountTopzCrct"));
        labelAmountTopzCrct->setMinimumSize(QSize(0, 36));

        horizontalLayout_5->addWidget(labelAmountTopzCrct, 0, Qt::AlignTop);
        ...
        labelAmountCrct = new QLabel(bottom_container);
        labelAmountCrct->setObjectName(QStringLiteral("labelAmountCrct"));

        verticalLayout_2->addWidget(labelAmountCrct);
        ...
        labelPendingCrct = new QLabel(bottom_container);
        labelPendingCrct->setObjectName(QStringLiteral("labelPendingCrct"));

        verticalLayout_3->addWidget(labelPendingCrct);
        ...
        labelImmatureCrct = new QLabel(bottom_container);
        labelImmatureCrct->setObjectName(QStringLiteral("labelImmatureCrct"));

        verticalLayout_4->addWidget(labelImmatureCrct);
...
"border:none;"));
        ...
        labelAmountzCrct = new QLabel(bottom_container);
        labelAmountzCrct->setObjectName(QStringLiteral("labelAmountzCrct"));

        verticalLayout->addWidget(labelAmountzCrct);
        ...
        labelPendingzCrct = new QLabel(bottom_container);
        labelPendingzCrct->setObjectName(QStringLiteral("labelPendingzCrct"));

        verticalLayout_5->addWidget(labelPendingzCrct);
        ...
        labelImmaturezCrct = new QLabel(bottom_container);
        labelImmaturezCrct->setObjectName(QStringLiteral("labelImmaturezCrct"));

        verticalLayout_6->addWidget(labelImmaturezCrct);
    ...
    void retranslateUi(QWidget *TopBar)
    {
        ...
        labelAmountTopCrct->setText(QApplication::translate("TopBar", "480.0685 FRAG", Q_NULLPTR));
        label_16->setText(QString());
        labelAmountTopzCrct->setText(QApplication::translate("TopBar", "1,000 zFRAG", Q_NULLPTR));
        labelTitle1->setText(QApplication::translate("TopBar", "Available", Q_NULLPTR));
        labelAmountCrct->setText(QApplication::translate("TopBar", "480.0685 FRAG", Q_NULLPTR));
        labelTitle3->setText(QApplication::translate("TopBar", "Pending", Q_NULLPTR));
        labelPendingCrct->setText(QApplication::translate("TopBar", "6.943 FRAG", Q_NULLPTR));
        labelTitle4->setText(QApplication::translate("TopBar", "Immature", Q_NULLPTR));
        labelImmatureCrct->setText(QApplication::translate("TopBar", "10 FRAG", Q_NULLPTR));
        label_9->setText(QString());
        labelTitle2->setText(QApplication::translate("TopBar", "Available", Q_NULLPTR));
        labelAmountzCrct->setText(QApplication::translate("TopBar", "1,000 zFRAG", Q_NULLPTR));
        labelTitle5->setText(QApplication::translate("TopBar", "Pending", Q_NULLPTR));
        labelPendingzCrct->setText(QApplication::translate("TopBar", "60 zFRAG", Q_NULLPTR));
        labelTitle6->setText(QApplication::translate("TopBar", "Immature", Q_NULLPTR));
        labelImmaturezCrct->setText(QString());
