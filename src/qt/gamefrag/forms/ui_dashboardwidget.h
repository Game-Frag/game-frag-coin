...
public:
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountCrct = new QLabel(right);
        labelAmountCrct->setObjectName(QStringLiteral("labelAmountCrct"));
        labelAmountCrct->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(labelAmountCrct);
        ...
        labelSquareCrct = new QLabel(verticalWidgetChart);
        labelSquareCrct->setObjectName(QStringLiteral("labelSquareCrct"));
        labelSquareCrct->setMinimumSize(QSize(14, 14));
        labelSquareCrct->setMaximumSize(QSize(14, 14));

        horizontalLayout_4->addWidget(labelSquareCrct);

        labelCrct = new QLabel(verticalWidgetChart);
        labelCrct->setObjectName(QStringLiteral("labelCrct"));

        horizontalLayout_4->addWidget(labelCrct);
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountCrct->setText(QApplication::translate("DashboardWidget", "TextLabel", Q_NULLPTR));
        labelAmountMNRewards->setText(QApplication::translate("DashboardWidget", "TextLabel", Q_NULLPTR));
        labelChart->setText(QApplication::translate("DashboardWidget", "Staking and MNR statistics", Q_NULLPTR));
        labelSquareCrct->setText(QString());
        labelCrct->setText(QApplication::translate("DashboardWidget", "FRAG", Q_NULLPTR));
        labelSquareMNRewards->setText(QString());
        labelMNRewards->setText(QApplication::translate("DashboardWidget", "FRAG MNR", Q_NULLPTR));
