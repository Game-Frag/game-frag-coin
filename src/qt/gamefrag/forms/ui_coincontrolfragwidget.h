/********************************************************************************
** Form generated from reading UI file 'coincontrolfragwidget.ui'
**
...
#ifndef UI_COINCONTROLFRAGWIDGET_H
#define UI_COINCONTROLFRAGWIDGET_H
...
class Ui_CoinControlCrctWidget
{
public:
    ...
    void setupUi(QWidget *CoinControlCrctWidget)
    {
        if (CoinControlCrctWidget->objectName().isEmpty())
            CoinControlCrctWidget->setObjectName(QStringLiteral("CoinControlCrctWidget"));
        CoinControlCrctWidget->resize(918, 552);
        CoinControlCrctWidget->setStyleSheet(QStringLiteral(""));
        verticalLayout_2 = new QVBoxLayout(CoinControlCrctWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        frameContainer = new QFrame(CoinControlCrctWidget);
        ...
        retranslateUi(CoinControlCrctWidget);

        QMetaObject::connectSlotsByName(CoinControlCrctWidget);
    } // setupUi

    void retranslateUi(QWidget *CoinControlCrctWidget)
    {
        CoinControlCrctWidget->setWindowTitle(QApplication::translate("CoinControlCrctWidget", "Dialog", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("CoinControlCrctWidget", "Transaction Details", Q_NULLPTR));
        btnEsc->setText(QApplication::translate("CoinControlCrctWidget", "PushButton", Q_NULLPTR));
        labelTitleAmount->setText(QApplication::translate("CoinControlCrctWidget", "FRAG:", Q_NULLPTR));
        labelValueAmount->setText(QApplication::translate("CoinControlCrctWidget", "TextLabel", Q_NULLPTR));
        labelTitleQuantity->setText(QApplication::translate("CoinControlCrctWidget", "Quantity:", Q_NULLPTR));
        labelValueQuantity->setText(QApplication::translate("CoinControlCrctWidget", "TextLabel", Q_NULLPTR));
        labelTitleFee->setText(QApplication::translate("CoinControlCrctWidget", "Fee:", Q_NULLPTR));
        labelValueFee->setText(QApplication::translate("CoinControlCrctWidget", "TextLabel", Q_NULLPTR));
        labelTitleDenom->setText(QApplication::translate("CoinControlCrctWidget", "Amount", Q_NULLPTR));
        labelTitleId->setText(QApplication::translate("CoinControlCrctWidget", "Label", Q_NULLPTR));
        labelTitleVersion->setText(QApplication::translate("CoinControlCrctWidget", "Address", Q_NULLPTR));
        labelTitleType->setText(QApplication::translate("CoinControlCrctWidget", "Type", Q_NULLPTR));
        labelTitleSpen->setText(QApplication::translate("CoinControlCrctWidget", "Date", Q_NULLPTR));
        labelTitleConfirmations->setText(QApplication::translate("CoinControlCrctWidget", "Confirmations", Q_NULLPTR));
        checkBoxAll->setText(QApplication::translate("CoinControlCrctWidget", "CheckBox", Q_NULLPTR));
        labelTitleBytes->setText(QApplication::translate("CoinControlCrctWidget", "Bytes:", Q_NULLPTR));
        labelValueBytes->setText(QApplication::translate("CoinControlCrctWidget", "TextLabel", Q_NULLPTR));
        labelTitleDust->setText(QApplication::translate("CoinControlCrctWidget", "Dust:", Q_NULLPTR));
        labelValueDust->setText(QApplication::translate("CoinControlCrctWidget", "TextLabel", Q_NULLPTR));
        labelTitleChange->setText(QApplication::translate("CoinControlCrctWidget", "Change:", Q_NULLPTR));
        labelValueChange->setText(QApplication::translate("CoinControlCrctWidget", "TextLabel", Q_NULLPTR));
        labelTitleAfter->setText(QApplication::translate("CoinControlCrctWidget", "After Fee: ", Q_NULLPTR));
        labelValueAfter->setText(QApplication::translate("CoinControlCrctWidget", "TextLabel", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("CoinControlCrctWidget", "CANCEL", Q_NULLPTR));
        btnSave->setText(QApplication::translate("CoinControlCrctWidget", "OK", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CoinControlCrctWidget: public Ui_CoinControlCrctWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_COINCONTROLFRAGWIDGET_H
