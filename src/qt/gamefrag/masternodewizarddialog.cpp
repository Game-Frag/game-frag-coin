...
#include "qt/gamefrag/forms/ui_masternodewizarddialog.h"
    ...
    clientModel(_clientModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a GAMEFRAG Masternode you must dedicate %1 (the unit of GAMEFRAG) "
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("62020");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("52020");
    } else {
        ui->lineEditPort->setText("42020");
    }
