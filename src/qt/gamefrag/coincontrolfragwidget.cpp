...
#include "qt/gamefrag/forms/ui_coincontrolfragwidget.h"
    ...
    ui(new Ui::CoinControlCrctWidget)
{
    ...
    ui->labelTitle->setText("Select FRAG Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("FRAG");
    ...
    ui->labelValueAfter->setText("0.00 FRAG");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 FRAG");
    ui->labelValueFee->setText("0.00 FRAG");
