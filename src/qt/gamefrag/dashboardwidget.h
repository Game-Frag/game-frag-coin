...
#include "config/gamefrag-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalFrag = 0;
    qint64 totalZfrag = 0;
    QList<qreal> valuesFrag;
    QList<qreal> valueszFrag;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(GAMEFRAGGUI* _window);
    ~DashboardWidget();
