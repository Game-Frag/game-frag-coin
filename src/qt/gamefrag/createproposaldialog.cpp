...
#include "qt/gamefrag/createproposaldialog.h"
#include "qt/gamefrag/forms/ui_createproposaldialog.h"

#include "qt/gamefrag/contactsdropdown.h"
#include "qt/gamefrag/governancemodel.h"
...
CreateProposalDialog::CreateProposalDialog(GAMEFRAGGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.gamefrag/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 FRAG");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<GAMEFRAGGUI*>(parent()),
                this
        );
