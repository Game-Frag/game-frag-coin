...
#include "qt/gamefrag/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, GAMEFRAGGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
