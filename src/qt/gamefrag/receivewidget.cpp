...
#include "qt/gamefrag/forms/ui_receivewidget.h"
...
#include "qt/gamefrag/addressholder.h"
...
ReceiveWidget::ReceiveWidget(GameFragGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive FRAG."));
