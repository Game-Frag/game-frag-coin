...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " gamefrag-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  gamefrag-tx [options] <hex-tx> [commands]  Update hex-encoded gamefrag transaction\n" +
                               "or:     gamefrag-tx [options] -create [commands]   Create hex-encoded gamefrag transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gamefrag transaction
