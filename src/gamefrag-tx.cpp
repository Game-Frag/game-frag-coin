...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("Gamefrag Core gamefrag-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gamefrag-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gamefrag transaction") + "\n" +
                               "  gamefrag-tx [options] -create [commands]   " + _("Create hex-encoded gamefrag transaction") + "\n" +
                               "\n";
