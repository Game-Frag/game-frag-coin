...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("4e68685ed879c14d41d301902b43ceb6403248cf23f14c46070dc623303286d6ab99752a91748d9ce4bfcb6b20ff0b2e3eb8f14e23b46196733316ec29d76e617");
        nDefaultPort = 42020;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // GameFrag starting difficulty is 1 / 2^12
        ...
        nMaxMoneyOut = 22500000000 * COIN;
        nMinColdStakingAmount = 1 * COIN;

        nMasternodeCollateral = 1000000;
        strDevFundAddress = "WebDhZKnSVHrjmq2Zupnr19xfiDB25WRjs";
        nStakeInputMinimal = 2500 * COIN;

        /** Height or Time Based Activations **/
        nLastPOWBlock = 2000;
        nGamefragBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nGamefragBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "GameFrag is built for esports and professional gamers. Frag not lag.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 250 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c9faf08887749ab6aea85bf1201d11dd4baefef90a16a19d63831cb63a5718a0d09726263fc71b42451a4fad265f8809fb464e6c0318c76203f8d62d321b9522") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 5;
        genesis.nTime = 1585261524; // Set to current epoch time https://www.epochconverter.com/
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1925549; // SET to 0 to regen
		...
		*/
        assert(hashGenesisBlock == uint256("0x0000084c0111692b872202123b4b98c519165b0f2aae3e2c483ab28615cf3c6b"));
        assert(genesis.hashMerkleRoot == uint256("0x4f0d0853a8f145da5725ba837276a50264c064f2eee22fe2b2be363eeccf6830"));

        //vSeeds.push_back(CDNSSeedData("seed1",   "seed1.game-frag.com"));     // Primary DNS Seeder
        //vSeeds.push_back(CDNSSeedData("seed2",   "seed2.game-frag.com")); 
        //vSeeds.push_back(CDNSSeedData("seed3",   "seed3.game-frag.com"));   
		vFixedSeeds.clear();
		vSeeds.clear();
		
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 38);      // Base 58 Letter 'G'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 35);      // Base 58 Letter 'F'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 28);     // Base 58 Letter 'C'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 63);			 // Base 58 Letter 'S'
		...
		*/
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zfrag to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04c9faf08887749ab6aea85bf1201d11dd4baefef90a16a19d63831cb63a5718a0d09726263fc71b42451a4fad265f8809fb464e6c0318c76203f8d62d321b9522");
        nDefaultPort = 42030;
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nGamefragBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nGamefragBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        genesis.nTime = 1585261609;
        genesis.nNonce = 3193253;// SET to 0 to regen
		...
		*/
        assert(hashGenesisBlock == uint256("0x00000a3bb59aa64824cd54a036a374f432f798f86a7a053d6eb851b508cd3d74"));
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1585261645;
        genesis.nNonce = 554964; // SET to 0 to regen
		...
		*/
        assert(hashGenesisBlock == uint256("0x000008724897f42e87434e279041bde26465ef99a70f92d803a9b3a7b974a342"));
