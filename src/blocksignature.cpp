...
bool CheckBlockSignature(const CBlock& block, const bool enableP2PKH)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either zFRAG or normal UTXO
     *  zFRAG: Each zFRAG has a keypair associated with it. The serial number is a hash of the public key.
