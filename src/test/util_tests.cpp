...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("gamefrag"), "Gamefrag");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://gamefrag.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/gamefrag"));
    BOOST_CHECK(validateURL("https://foo.bar/gamefrag/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.gamefrag.com"));
