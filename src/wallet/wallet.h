...
#ifndef GAMEFRAG_WALLET_H
#define GAMEFRAG_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_GAMEFRAG = 61000, // inherited version..
...
public:
     ...
     * GAMEFRAG: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    bool CreateCoinstakeOuts(const CFragStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
