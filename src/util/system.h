...
extern const char * const GAMEFRAG_CONF_FILENAME;
extern const char * const GAMEFRAG_PID_FILENAME;
extern const char * const GAMEFRAG_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("gamefrag-%s", name);
