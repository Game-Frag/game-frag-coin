...
#ifndef GAMEFRAG_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define GAMEFRAG_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // GAMEFRAG_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
