...
---------------------------------------------------------
Updates all the copyright headers of `The GAMEFRAG Core developers` which were
changed in a year more recent than is listed. For example:
```
// Copyright (c) <firstYear>-<lastYear> The GAMEFRAG Core developers
```
will be updated to:
```
// Copyright (c) <firstYear>-<lastModifiedYear> The GAMEFRAG Core developers
```
...
those cases:
```
// Copyright (c) <year> The GAMEFRAG Core developers
```
will be updated to:
```
// Copyright (c) <year>-<lastModifiedYear> The GAMEFRAG Core developers
```
where the update is appropriate.

copyright\_header.py insert \<file\>
------------------------------------
Inserts a copyright header for `The GAMEFRAG Core developers` at the top of the
...
If the file already has a copyright for `The GAMEFRAG Core developers`, the
script will exit.
...
If there are any errors the return value will be 1 and output like this will be printed:
    ...
    .../64/test_gamefrag: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_gamefrag: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_gamefrag: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_gamefrag: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
