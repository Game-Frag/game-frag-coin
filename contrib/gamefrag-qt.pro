...
RESOURCES += src/qt/gamefrag.qrc src/qt/gamefrag_locale.qrc

TRANSLATIONS += src/qt/locale/gamefrag_bg.ts \
                src/qt/locale/gamefrag_de.ts \
                src/qt/locale/gamefrag_en.ts \
                src/qt/locale/gamefrag_es.ts \
                src/qt/locale/gamefrag_fi.ts \
                src/qt/locale/gamefrag_fr.ts \
                src/qt/locale/gamefrag_it.ts \
                src/qt/locale/gamefrag_ja.ts \
                src/qt/locale/gamefrag_pl.ts \
                src/qt/locale/gamefrag_pt.ts \
                src/qt/locale/gamefrag_ru.ts \
                src/qt/locale/gamefrag_sk.ts \
                src/qt/locale/gamefrag_sv.ts \
                src/qt/locale/gamefrag_vi.ts \
                src/qt/locale/gamefrag_zh_CN.ts \
                src/qt/locale/gamefrag_zh_TW.ts
